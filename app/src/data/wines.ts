...
export const WINES: Wine[] = [
    ...
    profileTags: ['bold', 'fruity', 'tannic', 'floral', 'acidic', 'dry'],
    whyTemplate:
  ...
  },
  {
    ...
    profileTags: ['crisp', 'spicy', 'floral', 'light', 'acidic', 'dry'],
    whyTemplate:
    ...
    profileTags: ['mineral', 'lean', 'crisp', 'acidic', 'light', 'dry'],
    whyTemplate:
    ...
    profileTags: ['light', 'floral', 'fruity', 'elegant', 'acidic', 'dry'],
    whyTemplate:
  ...
  },
  {
    ...
    profileTags: ['complex', 'fruity', 'tannic', 'elegant', 'acidic', 'dry'],
    whyTemplate:
